<?php
class Album_tipo extends Executa
{
	private $id;
	private $nome; 
	private $criterio;
	...
	public function selecionar()
	{
		...
		$q .= "FROM ".$this->prefixo."_tbl_album_tipo 
		WHERE 
		1=1  
		";
	...
	public function inserir()
	{
		...
		INSERT INTO ".$this->prefixo."_tbl_album_tipo
		(
	...
	public function editar()
	{
		...
		UPDATE ".$this->prefixo."_tbl_album_tipo SET 
	...
	public function excluir()
	{
		...
		DELETE FROM ".$this->prefixo."_tbl_album_tipo WHERE id='".$this->id."'";
		//die($q);
		//Envia a string de consulta
		$this->sql = $q;
		$stmt = $this->executar();
	...
	public function ultimo_id()
	{
		...
		SELECT LAST_INSERT_ID(id) AS id  FROM ".$this->prefixo."_tbl_album_tipo ORDER BY id DESC LIMIT 1
